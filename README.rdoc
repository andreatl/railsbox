...
Authenticatin based on {Ryan Bates Screencast}[http://railscasts.com/episodes/250-authentication-from-scratch], basics of system from {Phyo Wai's Guide}[http://www.prowl.in/sharebox.html]
